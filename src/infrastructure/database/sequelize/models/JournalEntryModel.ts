...
export class JournalEntryModel extends Model {
  ...
  @Column({ type: DataType.DECIMAL(30, 10), allowNull: false, defaultValue: '0.0000000000' }) declare amount_us: string;
  @Column({ type: DataType.DECIMAL(30, 10), allowNull: false, defaultValue: '0.0000000000' }) declare amount_them: string;
