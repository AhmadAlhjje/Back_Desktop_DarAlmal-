...
export class TransferMovementModel extends Model {
  ...
  @Column({ type: DataType.DECIMAL(20, 4), allowNull: false }) declare transfer_amount: string;
  ...
  @Column({ type: DataType.DECIMAL(20, 8), allowNull: false }) declare first_exchange_rate: string;
  @Column({ type: DataType.DECIMAL(20, 8), allowNull: false }) declare second_exchange_rate: string;
  @Column({ type: DataType.DECIMAL(20, 4), allowNull: false }) declare fee_us: string;
  @Column({ type: DataType.DECIMAL(20, 4), allowNull: false }) declare fee_them: string;
  @Column(DataType.DECIMAL(10, 4)) declare fee_us_percentage: string | null;
  @Column(DataType.DECIMAL(10, 4)) declare fee_them_percentage: string | null;
